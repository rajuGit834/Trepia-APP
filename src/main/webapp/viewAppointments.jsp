            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form action="DashboardServlet" method="post">
                     	<button type=submit class="btn btn-primary rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0">View Requests</button>
                	 </form>
                </div>
            </nav>
        </div>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-1" style="max-width: 900px;">
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    ...
                    <li class="breadcrumb-item active text-primary">Appointment View Page</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
	    ...
	    <div class="container py-5 text-center">
	        <div class="row justify-content-center">
	            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
	              <h2 style="color:red;">APPOINTMENTS</h2><br>
	                <div class="d-flex justify-content-center"> <!-- Centering div -->
	                    <table class="table table-success table-striped">
	                    	<tbody>
	                    		...
	                    		<c:forEach var="request" items="${allAppointments}">
									<tr>
										<td class="table-content">${request.getId()}</td>
										<td class="table-content">${request.getFullName()}</td>
										<td class="table-content">${request.getEmail()}</td>
										<td class="table-content">${request.getPhone()}</td>
										<td class="table-content">${request.getGender()}</td>
										<td class="table-content">${request.getDate()}</td>
										<td class="table-content">${request.getDepartment()}</td>
										<td class="table-content">${request.getMessage()}</td>
										<td class="table-content">${request.getTime()}</td>
										<td class="table-content">
										<form>
											<button type="submit" name="id" value="${request.id}">Delete</button>
										</form>
										</td>
									</tr>
								</c:forEach>
                 ...
                 <div class="row justify-content-center"> <!-- New row for centering -->
