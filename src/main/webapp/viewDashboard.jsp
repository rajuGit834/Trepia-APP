                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                     ...
                     <form action="AppointmentServlet" method="post">
                     	<button type=submit class="btn btn-primary rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0">View Appointments</button>
                	 </form>
                </div>
            </nav>
        </div>
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-1" style="max-width: 900px;">
                <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    ...
                    <li class="breadcrumb-item active text-primary">Contact Request Page</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
       ...
       <div class="container-fluid py-5">
	    <div class="container py-5 text-center">
	        <div class="row justify-content-center">
	            ...
	            <h2 style="color:red;">CONTACT REQUEST</h2><br>
